...
const mutual_funds_api_service_1 = require("./mutual-funds-api.service");
const mutual_funds_service_1 = require("./mutual-funds.service");
let MutualFundsModule = class MutualFundsModule {
};
MutualFundsModule = __decorate([
    (0, common_1.Module)({
        providers: [mutual_funds_api_service_1.MutualFundsApiService, mutual_funds_service_1.MutualFundsService],
    })
], MutualFundsModule);
