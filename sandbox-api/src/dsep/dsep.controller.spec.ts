...
// Request Response JSON imports for Gercom
import * as GercomSearchRequest from "./gercom-courses/request/request.searchByCategorySchool.json";
import * as GercomSearchResponse from "./gercom-courses/response/response.searchByCategorySchool.json";
import * as GercomSelectRequest from "./gercom-courses/request/request.select.json";
import * as GercomSelectResponse from "./gercom-courses/response/response.select.json";
import * as GercomInitRequest from "./gercom-courses/request/request.init.json";
import * as GercomInitResponse from "./gercom-courses/response/response.init.json";
import * as GercomConfirmRequest from "./gercom-courses/request/request.confirm.json";
import * as GercomConfirmResponse from "./gercom-courses/response/response.confirm.json";
import * as GercomStatusRequest from "./gercom-courses/request/request.status.json";
import * as GercomStatusResponse from "./gercom-courses/response/response.status.json";
import * as GercomUpdateRequest from "./gercom-courses/request/request.update.json";
import * as GercomUpdateResponse from "./gercom-courses/response/response.update.json";
import * as GercomSupportRequest from "./gercom-courses/request/request.support.json";
import * as GercomSupportResponse from "./gercom-courses/response/response.support.json";
import * as GercomRatingRequest from "./gercom-courses/request/request.rating.json";
import * as GercomRatingResponse from "./gercom-courses/response/response.rating.json";
import * as GercomCancelRequest from "./gercom-courses/request/request.cancel.json";
import * as GercomCancelResponse from "./gercom-courses/response/response.cancel.json";
import * as GercomTrackRequest from "./gercom-courses/request/request.track.json";
import * as GercomTrackResponse from "./gercom-courses/response/response.track.json";
...
describe("DSEP:Gercom Courses Controller", () => {
    let controller: DsepController;
    ...
    // Gercom Courses E2E testing
    it("Should return Search response", () => {
        expect(controller.search(GercomSearchRequest as DSEPRequestDto)).toEqual(GercomSearchResponse);
    });
    it("Should return Select response", () => {
        expect(controller.select(GercomSelectRequest as DSEPRequestDto)).toEqual(GercomSelectResponse);
    });
    it("Should return Init response", () => {
        expect(controller.init(GercomInitRequest as DSEPRequestDto)).toEqual(GercomInitResponse);
    });
    it("Should return Confirm response", () => {
        expect(controller.confirm(GercomConfirmRequest as DSEPRequestDto)).toEqual(GercomConfirmResponse);
    });
    it("Should return Status response", () => {
        expect(controller.status(GercomStatusRequest as DSEPRequestDto)).toEqual(GercomStatusResponse);
    });
    it("Should return Update response", () => {
        expect(controller.update(GercomUpdateRequest as DSEPRequestDto)).toEqual(GercomUpdateResponse);
    });
    it("Should return Support response", () => {
        expect(controller.support(GercomSupportRequest as DSEPRequestDto)).toEqual(GercomSupportResponse);
    });
    it("Should return Rating response", () => {
        expect(controller.rating(GercomRatingRequest as DSEPRequestDto)).toEqual(GercomRatingResponse);
    });
    it("Should return Cancel response", () => {
        expect(controller.cancel(GercomCancelRequest as DSEPRequestDto)).toEqual(GercomCancelResponse);
    });
    it("Should return Track response", () => {
        expect(controller.track(GercomTrackRequest as DSEPRequestDto)).toEqual(GercomTrackResponse);
    });
});
